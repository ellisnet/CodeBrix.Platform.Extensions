================================================================================
README-INDEX: CodeBrix.Platform.Extensions
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Platform.Extensions.ApacheLicenseForever — general-purpose
      .NET helpers: functional/memoization, disposables, collections,
      equality comparers, ILogger extensions and threading primitives.
